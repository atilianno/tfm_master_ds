...
top10_clusters <- function(df, n_clusters){
  ...
  set.seed(123)
  df_top <- df
  km_clusters <- kmeans(x = df_top[, c("ENERGY_KCAL_100G", "FAT_100G", "CARBOHYDRATES_100G", "PROTEINS_100G", "SUGARS_100G", "SALT_100G")], centers = n_clusters, nstart = 50)
  ...
  for (cluster in 1:max(cluster_assignments)) {
    ...
    distancedf_normalizado <- apply(df_top[, c("ENERGY_KCAL_100G", "FAT_100G", "CARBOHYDRATES_100G", "PROTEINS_100G", "SUGARS_100G", "SALT_100G")], 1, function(row) {
  ...
  for (cluster in 1:max(cluster_assignments)) {
    cat("Cluster", cluster, ":\n")
    print(df_top[closest_products[[cluster]], c("PRODUCT_NAME", "ENERGY_KCAL_100G", "FAT_100G", "CARBOHYDRATES_100G", "PROTEINS_100G", "SUGARS_100G", "SALT_100G")])
    cat("\n")
  }
}
```
