...
```
# ELIMINAR ATIPICOS MULTIVARIANTES CON DBSCAN
```{r}
# ELIMINAR ATIPICOS MULTIVARIANTES
# lof_scores <- lof(df_seitan[c("ENERGY_100G","PROTEINS_100G", "CARBOHYDRATES_100G", "FAT_100G")], minPts = 6)
# df_seitan <- df_seitan[lof_scores <= 1,]
```
